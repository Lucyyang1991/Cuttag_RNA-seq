...
samples = c("H1_vs_I1", "H1_vs_I2", 
           "H2_vs_I1", "H2_vs_I2",
           "H3_vs_I1", "H3_vs_I2")  # MACS3结果文件名

# 创建输出目录
output_dir = paste0(base_dir, "/peak_annotation_macs3")
...
# 1. 读取所有样本的峰文件
cat("读取峰文件...\n")
peak_files = paste0(base_dir, "/individual_peaks/", samples, ".macs3_peaks.bed")
